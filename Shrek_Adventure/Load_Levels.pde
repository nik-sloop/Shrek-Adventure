...
>>>>>>> fedb8007659bfdf5ff1bbf58d2877a6da1f83541
  ...
  obsticles[0][9] = new object(800,400,grassWidth,grassHeight,0,0,0,0,0,0,1); // third grass middle second
  obsticles[0][10] = new object(800,350,grassWidth,grassHeight,0,0,0,0,0,0,1); // third grass middle first
  obsticles[0][11] = new object(800,300,grassWidth,grassHeight,0,0,0,0,0,0,1); // third grass middle first
  obsticles[0][12] = new object(150,450,rockWidth,rockHeight,0,0,0,0,0,0,2); //rock
...
<<<<<<< HEAD
  ...
  obsticles[1][5] = new object(900,530,300,175,0,0,0,0,0,0,0); // ground 2 (layer 1)
  obsticles[1][6] = new object(1065,475,logWidth,logHeight,0,0,0,0,0,0,3); // first log
  obsticles[1][7] = new object(1120,475,logWidth,logHeight,0,0,0,0,0,0,3); // second log bottom
  obsticles[1][8] = new object(1120,420,logWidth,logHeight,0,0,0,0,0,0,3); // second log top
  obsticles[1][9] = new object(125,170,1050,25,0,0,0,0,0,0,0); // ground 1 (layer 3)
  obsticles[1][10] = new object(0,0,25,350,0,0,0,0,0,0,0); // wall left
  obsticles[1][11] = new object(250,90,grassWidth,grassHeight,0,0,0,0,0,0,1); // first grass (layer 3)
...
<<<<<<< HEAD
  ...
  obsticles[2][9] = new object(850,400,grassWidth,grassHeight,0,0,0,0,0,0,1); // third grass middle second
  obsticles[2][10] = new object(850,350,grassWidth,grassHeight,0,0,0,0,0,0,1); // third grass middle first
  obsticles[2][11] = new object(850,300,grassWidth,grassHeight,0,0,0,0,0,0,1); // third grass middle first
  obsticles[2][12] = new object(300,950,0,0,0,0,0,0,0,0,8); // text
